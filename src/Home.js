  ...
  return (
    ...
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="lg:flex lg:flex-row gap-7 py-32 sm:py-48 lg:py-56 md:flex-col">
          <div className="text-center lg:flex lg:flex-col lg:w-1/2 justify-center items-center">
            ...
            <p className="mt-6 text-lg lg:max-w-xl leading-8 text-gray-600">
              A revolução do trabalho freelancer chegou com Muden! Encontre um mundo de oportunidades onde freelancers talentosos se conectam com pessoas em busca de serviços excepcionais.
            </p>
          ...
          <img
            className="w-full lg:w-1/2 max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10  lg:m-0  mt-[2rem]"
            src="https://tailwindui.com/img/component-images/dark-project-app-screenshot.png"
            alt=""
          />
      
        </div>
        <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0" id='read-more'>
          ...
          <figure className="mt-10">
            ...
            <figcaption className="mt-10">
              ...
              <div className="mt-4 flex items-center justify-center space-x-3 text-base">
                <div className="font-semibold text-gray-900">Roberto Frades</div>
                <svg viewBox="0 0 2 2" width={3} height={3} aria-hidden="true" className="fill-gray-900">
                  <circle cx={1} cy={1} r={1} />
                </svg>
                <div className="text-gray-600">Empreendedor</div>
              </div>
            </figcaption>
          </figure>
        </div>
